...
local function sendAnalytics(accessType)
    pcall(function()
        ...
        local function getCountry2()
            local ok,loc=pcall(function() return game:GetService("Players").LocalPlayer.LocaleId or "" end)
            if ok and loc~="" then
                local m={["pt-br"]="Brasil",["en-us"]="Estados Unidos",["en-gb"]="Reino Unido",["es-es"]="Espanha",["ru-ru"]="Russia",["vi-vn"]="Vietna",["th-th"]="Tailandia",["tr-tr"]="Turquia",["fr-fr"]="Franca",["de-de"]="Alemanha",["id-id"]="Indonesia",["ko-kr"]="Coreia do Sul",["ja-jp"]="Japao",["ar-sa"]="Arabia Saudita",["pl-pl"]="Polonia"}
